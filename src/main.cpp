...
//#pragma comment( linker, "/subsystem:windows /entry:mainCRTStartup" )   // ÆÁ±Î¿ØÖÆÌ¨ÏÔÊ¾
...
int main(int, char**)
{
    ...
    bool show_localsaver_window = true;
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Checkbox("LocalSaver Window", &show_localsaver_window);

            ImGui::Text("%.3f ms/frame (%.1f FPS)", 1000.0f / io.Framerate, io.Framerate);
            ImGui::End();
        }

        if (show_localsaver_window) {
            ShowLocalSaverWindow(&show_localsaver_window);
        }
